...
Reboot the PC and check that the grub loader is working properly with:
...
Since we are using Radeon we can grep it like this:
...
After completing this part, reboot to make sure everything is ready for the vm.
...
(I recommend installing Windows 10 Pro)
